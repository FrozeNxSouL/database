...
<body>
    ...
    <div class="locatetype" >
        <a href="#" id="listview" class="listview">LIST VIEW</a>
        <a href="#" id="mapview" class="mapview">MAP VIEW</a>
    </div>
