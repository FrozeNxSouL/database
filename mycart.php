                                            ...
                                            <td>
                                                <form action='manage_cart.php' method='POST'>
                                                    <div class='input-group'>
                                                        ...
                                                        <input style='width:2rem' type='number' oninput='this.value = Math.round(this.value);' class='form-control text-center iquantity' id='iquantity' name = 'Mod_Quantity' onchange='this.form.submit();' value = '$value[food_quantity]'>
