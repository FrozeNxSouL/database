              ...
              <div class="branch-list">
                ...
                ?>
                  ...
                  <div class="branch-card" style="width: 18rem;">
                    <h5 class="branch-title-edit"><?php echo $objResult["branchName"]; ?></h5>
                    <p class="branch-address-edit"><?php echo $objResult["branchAddress"]; ?></p>
                    <a class="btn btn-danger" href="php/deletedata.php?branchID=<?php echo $objResult["branchID"]; ?>"><span class="material-symbols-outlined">delete</span></a>
                  </div>
                ...
                ?>
                  <div class="branch-card">
                    <form action="php/adddata.php" method="post" name="branch">

                      <input type="text" class="form-control" placeholder="branchName" name="branchName">
                      <input class="form-control" placeholder="branch address" name="branchAddress">

                      <input class="btn btn-success" type="submit"><span class="material-symbols-outlined">add</span>
                    </form>
                  </div>
              </div>
            </div>
